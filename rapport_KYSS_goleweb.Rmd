---
title: Psychometric Report On the questionnaire Kickstart Your Soft Skills based on
  the GOLEWEB database
theme: Sandstone
authors: Vanthournout, G., Hoefkans, A.
output:
  html_document:
    number_sections: yes
    toc: yes
  ...
  pdf_document:
    toc: yes
    toc_depth: '2'
organisation: AP University of Applied Sciences and Arts, Research group Data Driven
...
The following research questions are answered in the current psychometric report:
...
+ **RQ5:** What are descripitive statistics for the scales in the KYSS-questionnaire?
...
+ **RQ8:** Does Higer education institution predict scores on the scales in the KYSS-questionnaire?
...
## Predictive analyses using Institution as predictor
